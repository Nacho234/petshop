...
export const products = [
  ...
  { id: 1, name: 'Balanceado Perro Adulto 15kg', brand: 'Old Prince', cat: 'alimento', sub: 'alimento-minorista', price: 38900, tag: 'Más vendido', img: f('dogfood,bag', 11) },
  { id: 2, name: 'Balanceado Gato Adulto 7.5kg', brand: 'Royal Canin', cat: 'alimento', sub: 'alimento-minorista', price: 41200, img: f('catfood,bag', 12) },
  { id: 3, name: 'Balanceado Cachorro 3kg', brand: 'Pro Plan', cat: 'alimento', sub: 'alimento-minorista', price: 18900, img: f('dogfood,puppy', 13) },
  ...
  { id: 5, name: 'Caja Alimento Gato x10 (7.5kg)', brand: 'Excellent', cat: 'alimento', sub: 'alimento-mayorista', price: 360000, tag: 'Por mayor', img: f('catfood,box', 15) },
  ...
  { id: 7, name: 'Collar Antipulgas', brand: 'Kong', cat: 'accesorios', sub: 'accesorios-collares', price: 9200, tag: 'Nuevo', img: f('puppy,collar', 22) },
  // Accesorios — Correas
  { id: 8, name: 'Correa Retráctil 5m', brand: 'PetComfort', cat: 'accesorios', sub: 'accesorios-correas', price: 12400, img: f('dog,leash', 23) },
  { id: 9, name: 'Correa de Cuero Reforzada', brand: 'Kong', cat: 'accesorios', sub: 'accesorios-correas', price: 15900, img: f('leather,leash', 24) },
  // Accesorios — Cosmética mascota
  { id: 10, name: 'Shampoo Hipoalergénico 500ml', brand: 'Vitalcan', cat: 'accesorios', sub: 'accesorios-cosmetica', price: 7300, img: f('shampoo,bottle', 25) },
  { id: 11, name: 'Perfume para Mascotas 120ml', brand: 'Excellent', cat: 'accesorios', sub: 'accesorios-cosmetica', price: 5400, img: f('perfume,bottle', 26) },

  // Juguetes de entretenimiento
  { id: 12, name: 'Pelota de Caucho Resistente', brand: 'Kong', cat: 'juguetes', sub: null, price: 8990, tag: 'Más vendido', img: f('dog,ball', 31) },
  { id: 13, name: 'Soga Mordedor Trenzada', brand: 'PlayPet', cat: 'juguetes', sub: null, price: 4990, img: f('rope,toy', 32) },
  { id: 14, name: 'Ratón con Catnip x3', brand: 'PlayCat', cat: 'juguetes', sub: null, price: 4290, img: f('cat,toy,mouse', 33) },
  { id: 15, name: 'Hueso de Juguete Sonoro', brand: 'PlayPet', cat: 'juguetes', sub: null, price: 3990, tag: 'Nuevo', img: f('dog,bone', 34) },
]
